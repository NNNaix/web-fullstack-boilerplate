...
import { MenuSection } from '@server/util/consts';
...
const SiderMenu: FC<SiderMenuProps> = ({ selectedKeys }) => {
    ...
    return (
        <div className="global-sider-menu">
            {menuSectionList.map((section, i) => (
                <div key={section[0].path} className="global-sider-menu-section">
                    <Menu selectedKeys={selectedKeys}>{getMenuItems(section)}</Menu>
